...
COMMON_FLAGS_GEN=$(RUST_PGO_GEN) $(PASS_MANAGER_RUST) -Clto=fat -Clink-arg=-Wl,--plugin-opt=-debug-pass=Arguments -Clinker-plugin-lto=on -Zrelro-level=full -Clink-arg=-flto=full -Cprefer-dynamic=no -Clink-arg=-Wl,--mllvm=-inlinehint-threshold=400 -Clink-arg=-Wl,--mllvm=-inlinedefault-threshold=400 -Clink-arg=-Wl,--mllvm=-inlinecold-threshold=400 -Clink-arg=-Wl,--mllvm=-inline-cost-full -Clink-arg=-Wl,--mllvm=-inline-cold-callsite-threshold=400 -Clink-arg=-Wl,--mllvm=-inline-threshold=400 -Clink-arg=-Wl,--plugin-opt=-inlinehint-threshold=400 -Clink-arg=-Wl,--plugin-opt=-inlinedefault-threshold=400 -Clink-arg=-Wl,--plugin-opt=-inlinecold-threshold=400 -Clink-arg=-Wl,--plugin-opt=-inline-cold-callsite-threshold=400 -Clink-arg=-Wl,--plugin-opt=-inline-threshold=400 -Cllvm-args=-inline-threshold=400 -Cinline-threshold=400 -L. --verbose -Clink-arg=--verbose -Clink-arg=-Wl,--verbose -Clink-arg=-L. -Clink-arg= -Zunstable-options -Clinker=clang -Clink-arg=-fuse-ld=lld -Copt-level=3 -Ccodegen-units=1 -Cpanic=abort -Ctarget-feature=+crt-static -Crelocation-model=static -Csave-temps=yes -Clink-arg=-Wl,--plugin-opt=save-temps -Clink-arg=-Wl,--save-temps -Clink-arg=--save-temps -Cstrip=debuginfo -Cdebuginfo=2 -Clink-arg=-fsave-optimization-record=yaml -Clink-arg=-foptimization-record-passes=.* -Clink-arg=-fdiagnostics-show-hotness -Clink-arg=-Wl,--plugin-opt=opt-remarks-passes=.*  -Clink-arg=-fsave-optimization-record=yaml -Clink-arg=-fdiagnostics-show-hotness -Clink-arg=-Wl,-O3,--sort-common,--as-needed,--lto-partitions=1,--lto-O3 -Ctarget-cpu=native -Cprefer-dynamic=no -Zplt=off -Ztune-cpu=native -Clink-arg=-Wl,-plugin-opt=O3,-plugin-opt=mcpu=native,-plugin-opt=lto-partitions=1 -Clink-arg=-Wl,--lto-O3 -Clink-arg=-Wl,-O3 -Clink-arg=-O3 -Clink-arg=-mno-vzeroupper -Clink-arg=-march=native -Clink-arg=-mtune=native -Crelocation-model=static -Cforce-frame-pointers=off -Cforce-unwind-tables=off -Cpanic=abort -Clink-arg=-Wl,-plugin-opt=-import-instr-limit=400 -Clink-arg=-fwhole-program-vtables -Clink-arg=-fforce-emit-vtables -Clink-arg=-Wl,--lto-whole-program-visibility -Zfunction-sections=no -Zprint-llvm-passes=no -Zcombine-cgu=yes -Clink-arg=-Wl,--mllvm=-inline-deferral -Zverbose=yes -Cembed-bitcode=yes --print link-args
...
COMMON_FLAGS_USE=$(RUST_PGO_USE) $(PASS_MANAGER_RUST) -Clto=fat -Clink-arg=-Wl,--plugin-opt=-debug-pass=Arguments -Clinker-plugin-lto=on -Zrelro-level=full -Clink-arg=-flto=full -Cprefer-dynamic=no -Clink-arg=-Wl,--mllvm=-inlinehint-threshold=400 -Clink-arg=-Wl,--mllvm=-inlinedefault-threshold=400 -Clink-arg=-Wl,--mllvm=-inlinecold-threshold=400 -Clink-arg=-Wl,--mllvm=-inline-cost-full -Clink-arg=-Wl,--mllvm=-inline-cold-callsite-threshold=400 -Clink-arg=-Wl,--mllvm=-inline-threshold=400 -Clink-arg=-Wl,--plugin-opt=-inlinehint-threshold=400 -Clink-arg=-Wl,--plugin-opt=-inlinedefault-threshold=400 -Clink-arg=-Wl,--plugin-opt=-inlinecold-threshold=400 -Clink-arg=-Wl,--plugin-opt=-inline-cold-callsite-threshold=400 -Clink-arg=-Wl,--plugin-opt=-inline-threshold=400 -Cllvm-args=-inline-threshold=400 -Cinline-threshold=400 -L. --verbose -Clink-arg=--verbose -Clink-arg=-Wl,--verbose -Clink-arg=-L. -Clink-arg= -Zunstable-options -Clinker=clang -Clink-arg=-fuse-ld=lld -Copt-level=3 -Ccodegen-units=1 -Cpanic=abort -Ctarget-feature=+crt-static -Crelocation-model=static -Csave-temps=yes -Clink-arg=-Wl,--plugin-opt=save-temps -Clink-arg=-Wl,--save-temps -Clink-arg=--save-temps -Cstrip=debuginfo -Cdebuginfo=2 -Clink-arg=-fsave-optimization-record=yaml -Clink-arg=-foptimization-record-passes=.* -Clink-arg=-fdiagnostics-show-hotness -Clink-arg=-Wl,--plugin-opt=opt-remarks-passes=.*  -Clink-arg=-fsave-optimization-record=yaml -Clink-arg=-fdiagnostics-show-hotness -Clink-arg=-Wl,-O3,--sort-common,--as-needed,--lto-partitions=1,--lto-O3 -Ctarget-cpu=native -Cprefer-dynamic=no -Zplt=off -Ztune-cpu=native -Clink-arg=-Wl,-plugin-opt=O3,-plugin-opt=mcpu=native,-plugin-opt=lto-partitions=1 -Clink-arg=-Wl,--lto-O3 -Clink-arg=-Wl,-O3 -Clink-arg=-O3 -Clink-arg=-mno-vzeroupper -Clink-arg=-march=native -Clink-arg=-mtune=native -Crelocation-model=static -Cforce-frame-pointers=off -Cforce-unwind-tables=off -Cpanic=abort -Clink-arg=-Wl,-plugin-opt=-import-instr-limit=400 -Clink-arg=-fwhole-program-vtables -Clink-arg=-fforce-emit-vtables -Clink-arg=-Wl,--lto-whole-program-visibility -Zfunction-sections=no -Zprint-llvm-passes=no -Zcombine-cgu=yes -Clink-arg=-Wl,--mllvm=-inline-deferral -Zverbose=yes -Cembed-bitcode=yes --print link-args
# -Clink-arg=-Rpass=.* -Clink-arg=-Rpass-missed=.* -Clink-arg=-Rpass-analysis=.*
# -Zthinlto=off
...
CFLAGS_GEN=$(CFLAGS_PGO_GEN) $(PASS_MANAGER_CFLAGS) -flto=full -O3 -g -fuse-ld=lld --verbose --save-temps -Wl,-O3,--sort-common,--as-needed,--lto-partitions=1,--lto-O3 -mllvm -inline-threshold=400 -march=native -mcpu=native -mtune=native -Wl,-mllvm,-mcpu=native -g -Wall -Wl,-mllvm,-x86-use-vzeroupper=0 -fembed-bitcode -Wl,--lto-partitions=1 -Wl,--lto-O3 -Wl,-O3 -O3 -mno-vzeroupper -march=native -mcpu=native -mtune=native -Wl,-mllvm,-mcpu=native -fuse-ld=lld -Wl,--as-needed -Wl,--build-id=sha1 -Wl,--enable-new-dtags -Wl,-plugin-opt=O3,-plugin-opt=mcpu=native,-plugin-opt=lto-partitions=1 -Wl,-z,now,-z,relro,-z,max-page-size=0x1000,-z,separate-code -Wno-error -mprefer-vector-width=256 -falign-functions=32 -fno-semantic-interposition -Wl,-Bsymbolic-functions -fno-stack-protector -fno-trapping-math -fno-math-errno -ftree-slp-vectorize -ftree-vectorize -feliminate-unused-debug-types -fno-plt -Wno-error -Wp,-D_REENTRANT -fvisibility-inlines-hidden -fomit-frame-pointer -fasynchronous-unwind-tables -static-libstdc++ -static-libgcc -pthread -pipe -mllvm -x86-use-vzeroupper=0 -fwhole-program-vtables -fforce-emit-vtables

# -fwhole-program-vtables -fforce-emit-vtables
CFLAGS_PGO_USE=-fprofile-use=/var/tmp/pgo/merged.profdata
CFLAGS_USE=$(CFLAGS_PGO_USE) $(PASS_MANAGER_CFLAGS) -flto=full -O3 -g -fuse-ld=lld --verbose --save-temps -Wl,-O3,--sort-common,--as-needed,--lto-partitions=1,--lto-O3 -mllvm -inline-threshold=400 -march=native -mcpu=native -mtune=native -Wl,-mllvm,-mcpu=native -g -Wall -Wl,-mllvm,-x86-use-vzeroupper=0 -fembed-bitcode -Wl,--lto-partitions=1 -Wl,--lto-O3 -Wl,-O3 -O3 -mno-vzeroupper -march=native -mcpu=native -mtune=native -Wl,-mllvm,-mcpu=native -fuse-ld=lld -Wl,--as-needed -Wl,--build-id=sha1 -Wl,--enable-new-dtags -Wl,-plugin-opt=O3,-plugin-opt=mcpu=native,-plugin-opt=lto-partitions=1 -Wl,-z,now,-z,relro,-z,max-page-size=0x1000,-z,separate-code -Wno-error -mprefer-vector-width=256 -falign-functions=32 -fno-semantic-interposition -Wl,-Bsymbolic-functions -fno-stack-protector -fno-trapping-math -fno-math-errno -ftree-slp-vectorize -ftree-vectorize -feliminate-unused-debug-types -fno-plt -Wno-error -Wp,-D_REENTRANT -fvisibility-inlines-hidden -fomit-frame-pointer -fasynchronous-unwind-tables -static-libstdc++ -static-libgcc -pthread -pipe -mllvm -x86-use-vzeroupper=0 -fwhole-program-vtables -fforce-emit-vtables
