...
CFLAGS_GEN=$(CFLAGS_PGO_GEN) -flto=full -O3 -g -fuse-ld=lld --verbose --save-temps -Wl,-O3,--sort-common,--as-needed,--lto-partitions=1,--lto-O3 -mllvm -inline-threshold=1400 -march=native -mcpu=native -mtune=native -Wl,-mllvm,-mcpu=native -g -Wall -Wl,-mllvm,-x86-use-vzeroupper=0 -mllvm -x86-use-vzeroupper=0 -enable-new-pm=1 -fembed-bitcode -Wl,--lto-partitions=1 -Wl,--lto-O3 -Wl,-O2 -O3 -mno-vzeroupper -march=native -mcpu=native -mtune=native -Wl,-mllvm,-mcpu=native -fuse-ld=lld -Wl,--as-needed -Wl,--build-id=sha1 -Wl,--enable-new-dtags -Wl,-plugin-opt=O3,-plugin-opt=mcpu=native,-plugin-opt=lto-partitions=1 -Wl,-z,now,-z,relro,-z,max-page-size=0x1000,-z,separate-code -Wno-error -mprefer-vector-width=256 -falign-functions=32 -fno-semantic-interposition -Wl,-Bsymbolic-functions -fno-stack-protector -fno-trapping-math -fno-math-errno -ftree-slp-vectorize -ftree-vectorize -feliminate-unused-debug-types -fno-plt -Wno-error -Wp,-D_REENTRANT -fvisibility-inlines-hidden -fomit-frame-pointer -fasynchronous-unwind-tables -static-libstdc++ -static-libgcc -pthread -pipe -fno-legacy-pass-manager -Wl,-mllvm,-enable-new-pm=1

# -fwhole-program-vtables -fforce-emit-vtables
#  -fno-legacy-pass-manager
CFLAGS_PGO_USE=-fprofile-use=/var/tmp/pgo/merged.profdata
CFLAGS_USE=$(CFLAGS_PGO_USE) -flto=full -O3 -g -fuse-ld=lld --verbose --save-temps -Wl,-O3,--sort-common,--as-needed,--lto-partitions=1,--lto-O3 -mllvm -inline-threshold=1400 -march=native -mcpu=native -mtune=native -Wl,-mllvm,-mcpu=native -g -Wall -Wl,-mllvm,-x86-use-vzeroupper=0 -mllvm -x86-use-vzeroupper=0 -enable-new-pm=1 -fembed-bitcode -Wl,--lto-partitions=1 -Wl,--lto-O3 -Wl,-O2 -O3 -mno-vzeroupper -march=native -mcpu=native -mtune=native -Wl,-mllvm,-mcpu=native -fuse-ld=lld -Wl,--as-needed -Wl,--build-id=sha1 -Wl,--enable-new-dtags -Wl,-plugin-opt=O3,-plugin-opt=mcpu=native,-plugin-opt=lto-partitions=1 -Wl,-z,now,-z,relro,-z,max-page-size=0x1000,-z,separate-code -Wno-error -mprefer-vector-width=256 -falign-functions=32 -fno-semantic-interposition -Wl,-Bsymbolic-functions -fno-stack-protector -fno-trapping-math -fno-math-errno -ftree-slp-vectorize -ftree-vectorize -feliminate-unused-debug-types -fno-plt -Wno-error -Wp,-D_REENTRANT -fvisibility-inlines-hidden -fomit-frame-pointer -fasynchronous-unwind-tables -static-libstdc++ -static-libgcc -pthread -pipe -fno-legacy-pass-manager -Wl,-mllvm,-enable-new-pm=1
