...
# 	clang++ -fuse-ld=lld -flto=full -O3 -gdwarf-4 -g -gline-tables-only -Wl,--no-rosegment -Wl,--build-id=sha1 -funique-internal-linkage-names -fbasic-block-sections=labels -static -static-libstdc++ -static-libgcc -pthread -fasynchronous-unwind-tables -Wl,--lto-basic-block-sections=labels -Wl,--lto-unique-basic-block-section-names -Wl,--lto-whole-program-visibility -fwhole-program-vtables -fforce-emit-vtables ./main.cpp -o ./teste
	#
...
# 	clang++ -fuse-ld=lld -flto=full -O3 -gdwarf-4 -g -gline-tables-only -Wl,--no-rosegment -Wl,--build-id=sha1 -funique-internal-linkage-names -fbasic-block-sections=labels -static -static-libstdc++ -static-libgcc -pthread -fasynchronous-unwind-tables -Wl,--lto-basic-block-sections=labels -Wl,--lto-unique-basic-block-section-names -Wl,--lto-whole-program-visibility -fwhole-program-vtables -fforce-emit-vtables -fprofile-sample-use=/insilications/build/git-clr/cross-lang-lto-pgo-smoketest3/merged.data ./main.cpp -o ./teste
	exa --long --all --icons ./teste
	ldd ./teste
	./teste
	sudo chown boni:boni *.old || :
