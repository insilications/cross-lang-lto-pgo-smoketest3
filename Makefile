...
CFLAGS_GEN=$(CFLAGS_PGO_GEN) $(PASS_MANAGER_CFLAGS) -fembed-bitcode -mllvm -import-instr-limit=33000 -mllvm -import-all-index -mllvm -import-full-type-definitions -mllvm -import-instr-evolution-factor=6 -mllvm -inline-cost-full -mllvm -inlinehint-threshold=19000 -mllvm -inlinedefault-threshold=19000 -mllvm -inlinecold-threshold=19000 -mllvm -inline-cold-callsite-threshold=19000 -mllvm -inline-threshold=19000 -Wl,--mllvm=-import-instr-limit=33000 -Wl,--mllvm=-import-all-index -Wl,--mllvm=-import-full-type-definitions -Wl,--mllvm=-import-instr-evolution-factor=6 -Wl,--mllvm=-inline-cost-full -Wl,--plugin-opt=-inlinehint-threshold=19000 -Wl,--plugin-opt=-inlinedefault-threshold=19000 -Wl,--plugin-opt=-inlinecold-threshold=19000 -Wl,--plugin-opt=-inline-cold-callsite-threshold=19000 -Wl,--plugin-opt=-inline-threshold=19000 -flto=thin -O3 -g -fuse-ld=lld --verbose -march=native -mcpu=native -mtune=native -Wl,--lto-whole-program-visibility -fwhole-program-vtables -fforce-emit-vtables  -Wno-unused-command-line-argument -fno-legacy-pass-manager -g -Wall -Wl,-mllvm,-x86-use-vzeroupper=0 -mllvm -x86-use-vzeroupper=0 -flto=thin -Wl,--lto-partitions=1 -Wl,--lto-O3 -Wl,-O2 -O3 -mno-vzeroupper -march=native -mtune=native -fuse-ld=lld -Wl,--as-needed -Wl,--enable-new-dtags -Wl,-plugin-opt=O3,-plugin-opt=lto-partitions=1 -Wl,-z,now,-z,relro,-z,max-page-size=0x1000,-z,separate-code -Wno-error -mprefer-vector-width=256 -falign-functions=32 -fno-semantic-interposition -Wl,-Bsymbolic-functions -fno-stack-protector -fno-trapping-math -fno-math-errno -ftree-slp-vectorize -ftree-vectorize -feliminate-unused-debug-types -fno-plt -Wno-error -Wp,-D_REENTRANT -fvisibility-inlines-hidden -fomit-frame-pointer -static-libstdc++ -static-libgcc -pthread -fasynchronous-unwind-tables -pipe -funique-internal-linkage-names -fbasic-block-sections=labels -gdwarf-4
