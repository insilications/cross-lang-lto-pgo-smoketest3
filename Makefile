...
tt1:
	...
	-@rm ./rsmain || :
	-@rm ./teste || :
# 	clang++ -fuse-ld=lld -flto=thin -g -Wl,--no-rosegment -Wl,--build-id=sha1 -static -static-libstdc++ -static-libgcc -pthread ./main.cpp -o ./teste
	clang++ -fuse-ld=lld -flto=thin -gdwarf-4 -g -gline-tables-only -Wl,--no-rosegment -Wl,--build-id=sha1 -static -static-libstdc++ -static-libgcc -pthread -fasynchronous-unwind-tables -Wl,--lto-whole-program-visibility -fwhole-program-vtables -fforce-emit-vtables ./main.cpp -o ./teste
...
# 	clang++ -fuse-ld=lld -flto=thin -g -Wl,--no-rosegment -Wl,--build-id=sha1 -static -static-libstdc++ -static-libgcc -pthread -fprofile-sample-use=/insilications/build/git-clr/cross-lang-lto-pgo-smoketest3/rustmerged.profdata ./main.cpp -o ./teste
	clang++ -fuse-ld=lld -flto=thin -gdwarf-4 -g -gline-tables-only -Wl,--no-rosegment -Wl,--build-id=sha1 -static -static-libstdc++ -static-libgcc -pthread -fasynchronous-unwind-tables -Wl,--lto-whole-program-visibility -fwhole-program-vtables -fforce-emit-vtables -fprofile-sample-use=/insilications/build/git-clr/cross-lang-lto-pgo-smoketest3/rustmerged.profdata ./main.cpp -o ./teste
	exa --long --all --icons ./teste
	ldd ./teste
	./teste
	sudo chown boni:boni *.old || :
